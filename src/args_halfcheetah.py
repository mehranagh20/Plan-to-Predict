...
def get_halfcheetah_args(parser):
    ...
    parser.add_argument('--rollout_min_epoch', type=int, default=1, metavar='A',
                        help='rollout min epoch') # default [20, 150, 1, 1]
    parser.add_argument('--rollout_max_epoch', type=int, default=10, metavar='A',
    ...
    parser.add_argument('--TrSTOP_TrgtRet', default=3200)
    ...
    parser.add_argument('--num_train_repeat', type=int, default=40, metavar='A',
