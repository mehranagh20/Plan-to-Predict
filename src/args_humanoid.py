...
def get_humanoid_args(parser):
    parser.add_argument('--project_name', default="plan-to-predict-Humanoid-v2"), 
    ...
    parser.add_argument('--n_trajs', default=3)
    ...
    parser.add_argument('--rollout_min_epoch', type=int, default=10, metavar='A',
                        help='rollout min epoch') # default 20 [20, 100, 1, 25]
    parser.add_argument('--rollout_max_epoch', type=int, default=80, metavar='A',
                        help='rollout max epoch') # default 100
    parser.add_argument('--rollout_min_length', type=int, default=1, metavar='A',
                        help='rollout min length') # default 1
    parser.add_argument('--rollout_max_length', type=int, default=9, metavar='A',
                        help='rollout max length') # default 25
    ...
    parser.add_argument('--aver_interval', type=int, default=10)
    parser.add_argument('--trgt_ret', default=4000)
    ...
    parser.add_argument('--pred_hidden_size', type=int, default=400, metavar='E',
