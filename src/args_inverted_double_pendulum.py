...
def get_inverted_double_pendulum_args(parser):
    ...
    parser.add_argument('--epoch_length', type=int, default=250, metavar='A',
                        help='steps per epoch') # default 1000
    parser.add_argument('--rollout_min_epoch', type=int, default=1, metavar='A',
                        help='rollout min epoch') # default [1, 15, 1, 1]
    parser.add_argument('--rollout_max_epoch', type=int, default=6, metavar='A',
                        help='rollout max epoch') # 80
    parser.add_argument('--rollout_min_length', type=int, default=1, metavar='A',
                        help='rollout min length')
    parser.add_argument('--rollout_max_length', type=int, default=2, metavar='A',
    ...
    parser.add_argument('--num_epoch', type=int, default=40, metavar='A',
                        help='total number of epochs')
    parser.add_argument('--DeterMoForMPC', default=False)
    parser.add_argument('--DeterPoForMPC', default=False)

    parser.add_argument('--Limit_Horizon', default=True)
    parser.add_argument('--MPCHorizon', default=5)
    ...
    parser.add_argument('--TrainEARLYSTOP', default=False)
    parser.add_argument('--TrSTOP_Aver_Interval', type=int, default=1)
    parser.add_argument('--TrSTOP_TrgtRet', default=-45)
    # parser.add_argument('--DeterPolForMPC', default=True)
